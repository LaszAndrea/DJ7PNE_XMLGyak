...
public class DOMQueryDJ7PNE {
	...
	public static void main(String argv[]) throws Exception {
		...
		doc.createComment("<!--Tasakrendelések-->");
		root.appendChild(createTRendeles(doc, "1", "1kg Gyermelyi finomliszt", "150000db", "80gr"));
		root.appendChild(createTRendeles(doc, "2", "2kg Hajdú búzadara", "100000db", "70gr"));
		root.appendChild(createTRendeles(doc, "3", "5kg Auschan Optimum", "50000db", "100gr"));

		// Vevõk

		doc.createComment("<!--Vevõk-->");
		...
		doc.createComment("<!--Tulajdonosok-->");
		...
		doc.createComment("<!--Szerzõdés kapcsolat-->");
	...
	private static Node createSzerzodes(Document doc, String tajszam, String tasakID, String adoszam, String rendeles) {
		...
		szer.setAttribute("tajszam", tajszam);
